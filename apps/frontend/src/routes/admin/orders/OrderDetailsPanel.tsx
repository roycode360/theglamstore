    ...
    <>
      <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            className="inline-flex items-center justify-center px-4 text-sm font-medium text-red-600 transition border border-red-200 rounded-md btn-ghost h-9 hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-200 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-60"
          ...
          <button
            className="inline-flex items-center justify-center px-4 text-sm font-medium rounded-md btn-ghost h-9 disabled:cursor-not-allowed disabled:opacity-60"
          ...
          <button
            className="inline-flex items-center justify-center px-4 text-sm font-semibold rounded-md btn-primary h-9 disabled:cursor-not-allowed disabled:opacity-60"
      ...
      {readOnly && (
        <div className="px-4 py-2 mb-4 text-xs border border-dashed rounded-md border-neutral-200 bg-neutral-50 text-neutral-600">
      ...
      <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
        <div className="space-y-6">
          ...
          <section className="p-4 space-y-4 border rounded-lg">
                  ...
                  <div className="space-y-2">
                    {productResults.map((product) => (
                      <button
                        key={product._id}
                        type="button"
                        className="flex items-center justify-between w-full px-3 py-2 text-sm text-left bg-white border rounded-md theme-border hover:bg-brand-50"
                    ...
                    <div className="grid gap-3 mt-4 md:grid-cols-4">
                      ...
                      {item.availableSizes?.length ? (
                        <label className="flex flex-col gap-1 text-xs font-medium">
                          Size
                          <select
                            className="px-2 py-2 text-sm border rounded-md theme-border"
          ...
          <section className="p-4 space-y-4 border rounded-lg">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <div className="flex items-end">
                <button
                  type="button"
                  className="h-10 px-3 text-xs rounded-md btn-secondary disabled:cursor-not-allowed disabled:opacity-60"
          ...
          <section className="p-4 space-y-3 border rounded-lg">
            <div className="text-xs font-semibold tracking-wide text-gray-500 uppercase">
              Notes
            </div>
            <textarea
